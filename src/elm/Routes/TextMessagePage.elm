...
textMessagePage model =
    ...
    div [ class "w-60-ns center tc" ]
        ...
        , div [ class "pa3" ] [ textarea [ class "vh-25 w-100 input-reset pa3 f4 br3 b-orange listOfVisits", onInput UpdateTextFeedback, value textValue, placeholder "Enter feedback here..." ] [] ]
