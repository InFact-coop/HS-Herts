module Routes.EndVisitQuestionPage exposing (..)
...
endVisitQuestionPage : Model -> Html Msg
endVisitQuestionPage model =
    div [ class "tc w-60-ns center main vh-100" ]
        ...
        , section [ class "center ma0 mt2 pt2" ]
            [ a [ href "#endVisitPage", class "link" ] [ button [ class "ma3 center db f3" ] [ text "Yes, end my visit" ] ]
